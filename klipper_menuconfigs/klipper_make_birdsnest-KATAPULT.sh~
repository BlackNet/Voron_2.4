...
cd ~/katapult/
make clean
make menuconfig KCONFIG_CONFIG=~//printer_data/config/klipper_menuconfigs/config-EBB36-KATAPULT
make KCONFIG_CONFIG=~//printer_data/config/klipper_menuconfigs/config-EBB36-KATAPULT
echo -e 
echo -e 
echo -e 
