...
cd ~/katapult/
make clean
#make menuconfig KCONFIG_CONFIG=~//printer_data/config/klipper_menuconfigs/config-MMB-CAN2-KATAPULT
make KCONFIG_CONFIG=~//printer_data/config/klipper_menuconfigs/config-MMB-CAN2-KATAPULT
echo -e 
echo -e 
echo -e 
